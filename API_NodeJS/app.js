...
const postApplicationRouter = require('./routes/post_applications.route');
const bookingRouter = require('./routes/bookings.route');
const paymentRouter = require('./routes/payments.route');
const classSessionsRouter = require('./routes/class_sessions.route');
...
app.use('/api/postApplications', postApplicationRouter);
app.use('/api/bookings', bookingRouter);
app.use('/api/payments', paymentRouter);
app.use('/api/classSessions', classSessionsRouter);
